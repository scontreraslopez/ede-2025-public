...
Últimamente hay especial concienciación sobre el tema de las vulnerabilidades de seguridad que pueden aparecer en producción. Por eso, en esta fase es común realizar auditorías de seguridad periódicas, aplicar parches y actualizaciones de librerías y frameworks, y monitorizar el sistema en busca de actividades sospechosas. Casos como el famoso **Log4Shell** en 2021, que afectó a miles de aplicaciones en todo el mundo debido a una vulnerabilidad en la popular librería Apache Log4j, han puesto de manifiesto la importancia crítica de gestionar adecuadamente las dependencias y mantener el software actualizado para protegerse contra amenazas emergentes. Aquí a todos los sistemas en producción les tocó actualizar rápidamente para mitigar el riesgo. Además, la adopción de prácticas de **DevSecOps** (integración de seguridad en DevOps) está ganando terreno, promoviendo la idea de que la seguridad debe ser una consideración desde las primeras fases del desarrollo y no solo en mantenimiento.

## 2.8. Comentarios finales sobre el SDLC y los proyectos de software

- Hay *listillos* que se piensan que una vez desplegado el software, entramos en una fase de coste 0. Nada más lejos de la realidad. El mantenimiento suele consumir entre el 60% y el 80% del coste total del ciclo de vida del software.
- El software es caro, muy caro. Se apoya en el recurso más caro de todos: el talento humano. Tendemos a verlo desde una simplificación excesiva (si yo cobro X por hora y tardo Y horas, el coste es X*Y), pero hay muchos costes ocultos (impuestos, gestión, coordinación, reuniones, formación, documentación, pruebas, errores, parches de emergencia, etc.) que hacen que el coste real sea mayor, mucho mayor. Como un iceberg, lo que ves es apenas el 20% del coste, de ahí la importancia de una buena gestión del proyecto y del ciclo de vida del software.
- Por muy informáticos que seamos y a pesar de que nos guste programar. Por lo general, es más barato buy than build (comprar software ya hecho que desarrollar uno desde cero), salvo en casos muy específicos donde se necesita una solución a medida o se busca una ventaja competitiva clara. Esto explica la popularidad de los ERP (Enterprise Resource Planning) y CRM (Customer Relationship Management) comerciales como SAP, Oracle, Microsoft Dynamics, Salesforce, etc. Muchas empresas optan por estas soluciones ya que les permiten cubrir sus necesidades con un coste y tiempo mucho menor que desarrollar un sistema propio desde cero.
- No os obsesionéis con usar la última tecnología o el framework de moda. La estabilidad, mantenibilidad y escalabilidad suelen ser más importantes que estar a la última. Muchas veces, tecnologías probadas y maduras son la mejor opción para proyectos empresariales serios.
- La comunicación con el cliente es clave en todas las fases. Entender sus necesidades, expectativas y feedback es fundamental para el éxito del proyecto.
- La gestión del cambio es crucial. Los requisitos pueden evolucionar y el equipo debe estar preparado para adaptarse sin perder el control del proyecto. *El cambio es la única constante en el desarrollo de software.*
- Tened presente el concepto de deuda técnica (*technical debt*). A veces, por prisas o falta de recursos, se toman atajos en el desarrollo que luego generan problemas a largo plazo. Es importante gestionar esta deuda y planificar su pago para evitar que se convierta en un lastre insostenible.
- *Lo mejor es enemigo de lo bueno.* - Voltaire. A veces, buscar la perfección puede llevar a retrasos innecesarios. Es mejor entregar un producto funcional y mejorarlo iterativamente que esperar a tener la solución perfecta desde el principio. Lo mismo ocurre con la documentación: a pesar de que es fundamental, y que su calidad supone un ahorro en las fases siguientes, no debe convertirse en un fin en sí mismo que retrase el desarrollo.
